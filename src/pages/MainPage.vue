<template>
    <div class="content">
      ...
      <p> Меня зовут Арина, рада представить вам проект, разработанный как техническое задание для отбора в вашу команду. Ниже будут
      ...
      <ul>
        ...
        <li>
          На третьем и последнем шаге предлагаю ознакомиться с материалом про декларативное и императивное программирование;
        </li>
        <li>
